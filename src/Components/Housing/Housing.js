  ...
  return (
    <div style={{ backgroundColor: "#f0f2f5" }}>
      <div className="info_page mx-auto justify-content-center">
        <p className="instance_header">{housing.project_name}</p>
        <Container className="instance_info">
          ...
          <div
            className="hous_map"
            dangerouslySetInnerHTML={{ __html: housing.map }}
          ></div>
          <Card
          ...
          <Card
            className="instance_data mx-auto mt-4"
            style={{
              borderTopRightRadius: "2rem",
              borderTopLeftRadius: "2rem",
            }}
          >
            ...
            >
              <ListGroup.Item>
                30% Median Family Income: {housing.units_30_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                40% Median Family Income: {housing.units_40_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                50% Median Family Income: {housing.units_50_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                60% Median Family Income: {housing.units_60_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                65% Median Family Income: {housing.units_65_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                80% Median Family Income: {housing.units_80_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                100% Median Family Income: {housing.units_100_mfi}
              </ListGroup.Item>
          ...
          >
            ...
            >
              <ListGroup.Item>
                Management Company: {housing.units_30_mfi}
              </ListGroup.Item>
              <ListGroup.Item>
                Phone Number: {housing.property_manager_phone_number}
              </ListGroup.Item>
          ...
          <Row className="mt-3 justify-content-between mx-auto">
            <Link to={link_j}>
              <Col className="mx-auto">
                <Button id="btn-back-to-top" variant="secondary">
                  Nearby Job
                </Button>{" "}
              </Col>
            </Link>
            <Link to={link_c}>
              <Col className="mx-auto">
                <Button variant="secondary">Child Care</Button>{" "}
              </Col>
            </Link>
          </Row>
        </Container>
