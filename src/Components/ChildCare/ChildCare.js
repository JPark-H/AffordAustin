    ...
    <div style={{ backgroundColor: "#f0f2f5" }}>
      <div className="info_page mx-auto justify-content-center">
        ...
        <Container className="instance_info">
          ...
          <Row>
            <Col>
              ...
              >
                ...
                >
                  <ListGroup.Item>
                    <b>Operation Type:</b> {child_care.operation_type}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Programs Provided:</b> {child_care.programs_provided}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Administrator's Name:</b>{" "}
                    {child_care.administrator_director_name}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Accepts Child Care Subsidies:</b>{" "}
                    {child_care.accepts_child_care_subsidies}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Days of Operation:</b> {child_care.days_of_operation}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Hours of Operations:</b> {child_care.hours_of_operation}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Licensed to Serve Ages:</b>{" "}
                    {child_care.licensed_to_serve_ages}
                  </ListGroup.Item>
                </ListGroup>
              </Card>
            </Col>
            <Col>
              ...
              >
                ...
                >
                  <ListGroup.Item>
                    <b>Phone Number:</b> {child_care.phone_number}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Website:</b>{" "}
                    <a href={child_care.website_address}>
                      {child_care.website_address}
                    </a>
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Address:</b> {child_care.location_address}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Mailing Address:</b> {child_care.mailing_address}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>County:</b> {child_care.county}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <b>Email Address:</b> {child_care.email_address}
                  </ListGroup.Item>
                </ListGroup>
              </Card>
            </Col>
          ...
          <div
            className="c_map"
            dangerouslySetInnerHTML={{ __html: child_care.map }}
          ></div>
          <Row className="mt-3 justify-content-between mx-auto">
            <Link to={link_j}>
              <Col className="mx-auto">
                <Button variant="secondary">Find Nearby Jobs</Button>{" "}
              </Col>
            </Link>
            <Link to={link_h}>
              <Col className="mx-auto">
                <Button variant="secondary">Find Nearby Housing</Button>{" "}
              </Col>
            </Link>
          </Row>
        </Container>
...
const ChildCare1 = () => {
  const child_care = {
    ...
    programs_provided:
      "School Age Care, Children with Special Needs, After School Care, Snacks Provided, Field Trips",
    ...
    location_address_geo: {
      ...
      longitude: "-97.773635",
      human_address:
        '{"address": "1900 BLUEBONNET LN AUSTIN TX- 78704 3342", "city": "", "state": "", "zip": ""}',
    },
    email_address: "none",
  ...
  return <ChildCare child_care={child_care} />;
};
...
const ChildCare2 = () => {
  const child_care = {
    ...
    programs_provided:
      "Meals Provided, After School Care, Snacks Provided, Drop-In Care, Skill Classes, Part Time Care, Transportation to/from School, Field Trips",
    ...
    location_address_geo: {
      ...
      longitude: "-97.800817",
      human_address:
        '{"address": "6507 JESTER BLVD BLDG II AUSTIN TX- 78750 8368", "city": "", "state": "", "zip": ""}',
    },
...
const ChildCare3 = () => {
  const child_care = {
    ...
    location_address_geo: {
      ...
      longitude: "-97.639908",
      human_address:
        '{"address": "17257 TOBERMORY DR PFLUGERVILLE TX- 78660 1726", "city": "", "state": "", "zip": ""}',
    },
    email_address: "none",
